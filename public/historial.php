 ...
 * Hoja de Vida y Trazabilidad del Activo - Versión V2.3
 */
...
<head>
    ...
    <style>
        ...
        /* Cuadro de Notas (Responsable Secundario y Adicionales) */
        .obs-box { 
            grid-column: 1 / -1; background: #f8fafc; padding: 10px; border-radius: 6px; 
            border-left: 4px solid #94a3b8; margin-top: 10px; font-size: 0.85rem; line-height: 1.5;
        }
        .obs-line { border-bottom: 1px solid #edf2f7; padding: 3px 0; }
            ...
            <div class="event-details">
                ...
                <div class="obs-box">
                    <?php if(!empty($ev['responsable_secundario'])): ?>
                        <div class="obs-line"><strong>👥 Responsable secundario:</strong> <?= htmlspecialchars($ev['responsable_secundario']) ?></div>
                    <?php endif; ?>
                    
                    <?php if(!empty($ev['campo_adic1'])): ?>
                        <div class="obs-line"><strong>📝 Campo adicional 1:</strong> <?= htmlspecialchars($ev['campo_adic1']) ?></div>
                    <?php endif; ?>
                    
                    <?php if(!empty($ev['campo_adic2'])): ?>
                        <div class="obs-line"><strong>📝 Campo adicional 2:</strong> <?= htmlspecialchars($ev['campo_adic2']) ?></div>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
            </div>
